    ...
    <div className="min-h-screen bg-gradient-to-br from-[#D0F0E0] via-white to-[#D0F0E0] p-8 text-[#0A0A32] flex flex-col justify-center">
      ...
      >
        ...
        <p className="text-2xl text-[#0A0A32] opacity-80 max-w-4xl mx-auto">
          The Complete diagnosis for Alzheimer's and Brain Tumors.
        </p>
...
>
  ...
  <p className="mt-6 text-xl opacity-80 max-w-4xl mx-auto">
    Detect and monitor Alzheimer's and brain tumors with cutting-edge AI technology, an intuitive interface, and multilingual support.
  </p>

  <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
    {["Medical Imaging Software", "AI-Powered Detection", "Multilingual ChatBot Support"].map((feature, index) => (
      <motion.div 
        key={index}
      ...
      >
        ...
        <p className="opacity-80 mt-3">
          {feature === "Medical Imaging Software" 
            ? "Processes .img and .hdr files with FSL, ensuring precise and reliable imaging data." 
            : feature === "AI-Powered Detection" 
            ? "Uses advanced models and heatmap visualization to assess brain scans accurately." 
            : "Supports English, Hindi, and Marathi for added diagnostic assistance with files."}
        </p>
      </motion.div>
    ))}
  </div>
